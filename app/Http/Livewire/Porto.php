...
class Porto extends Component
{
    ...
    public $portofolio, $portofolios, $title, $description, $image, $portofolio_id;
    ...
    public function store(){
        ...
        session()->flash('message', $this->portofolio_id ? $this->title.' berhasil di update' : 'Sukses membuat portofolio');
        $this->closeModal();
        $this->resetFields();
    }
